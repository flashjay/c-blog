...
CD.IniEditor = function(d) {
	CD.func.loadStyle('/css/editor.css');
		...
		switch(t){
			...
			case "alignmode":
				for(var i=0;i<CD.lang["alignmode"].length;i++){
					...
					d += "  <div unselectable='on' style='background:url(/editoricon.gif) -"+CD.lang["alignmode"][i][1]+"px 0;";
			...
			case "serial":
			   for(var i=0;i<CD.lang["serial"].length;i++){
					...
					d += "  <div unselectable='on' style='background:url(/editoricon.gif) -"+CD.lang["serial"][i][1]+"px 0;";
			...
			case "indent":
			   for(var i=0;i<CD.lang["indent"].length;i++){
					...
					d += "  <div unselectable='on' style='background:url(/editoricon.gif) -"+CD.lang["indent"][i][1]+"px 0;";
...
CD.toolbar = {
    create : function(id) {
		...
		for (var i = 0; i < CD.lang["items"].length; i++) {
			...
			tool += "background:url(/editoricon.gif) -"+CD.lang["items"][i][1]+"px 0;width:"+CD.lang["items"][i][2]+"px;";
